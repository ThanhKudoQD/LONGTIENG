...
const STAGE_LABEL: Record<string, string> = {
  ...
  'bible':            '1. Bible',
  'bible_1a':         '1A. Cast + Glossary',
  'bible_cast':       '1A. Cast',
  'bible_cast_saved': '1A. Save Cast',
  'bible_cast_done':  '1A. Cast ✓',
  'bible_glossary':       '1A.2 Glossary',
  'bible_glossary_saved': '1A.2 Save Glossary',
  'bible_glossary_done':  '1A.2 Glossary ✓',
